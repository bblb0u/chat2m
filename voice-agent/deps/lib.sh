...
DOWNLOAD_RETRIES="${CHAT2M_DOWNLOAD_RETRIES:-10}"
GIT_RETRIES="${CHAT2M_GIT_RETRIES:-5}"
PIP_RETRIES="${CHAT2M_PIP_RETRIES:-10}"
PIP_TIMEOUT="${CHAT2M_PIP_TIMEOUT:-120}"
RETRY_SLEEP_SECONDS="${CHAT2M_RETRY_SLEEP_SECONDS:-5}"
CURL_CONNECT_TIMEOUT="${CHAT2M_CURL_CONNECT_TIMEOUT:-20}"
CURL_SPEED_LIMIT="${CHAT2M_CURL_SPEED_LIMIT:-1024}"
CURL_SPEED_TIME="${CHAT2M_CURL_SPEED_TIME:-120}"
